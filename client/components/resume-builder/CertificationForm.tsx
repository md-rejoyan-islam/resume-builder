...
export function CertificationForm({
  ...
  const handleInputChange = (field: keyof Omit<Certification, "id">, value: string | boolean) => {
  ...
  const handleEditInputChange = (field: keyof Omit<Certification, "id">, value: string | boolean) => {
  ...
  const handleSaveEdit = () => {
    ...
    onCertificationsChange(
      certifications.map((cert) => (cert.id === editingCertification.id ? editingCertification : cert))
    );
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-card rounded-xl border border-border p-6 space-y-5">
        ...
        <div className="space-y-2">
          <label className="block text-xs font-bold uppercase tracking-wide text-slate-700 dark:text-muted-foreground">
            Certification / Achievement Name <span className="text-red-500">*</span>
          </label>
          <Input
            ref={firstInputRef}
            type="text"
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={cn(
                ...
                formData.noExpiration && "opacity-50 cursor-not-allowed bg-slate-100 dark:bg-slate-800"
              )}
            />
          </div>
        </div>
      ...
      {certifications.length === 0 && (
        <div className="text-center py-8 text-slate-500 dark:text-muted-foreground">
          ...
          <p className="text-xs mt-1">Add your first certification above to get started.</p>
        </div>
      )}
        ...
        <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleEditInputChange("issuer", e.target.value)}
                  placeholder="e.g. Amazon Web Services"
                  className="h-11"
                />
              </div>
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  onChange={(e) => handleEditNoExpirationChange(e.target.checked)}
                  className="w-4 h-4 text-primary border-slate-300 rounded focus:ring-primary"
                />
                <label
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleEditInputChange("credentialId", e.target.value)}
                    placeholder="e.g. ABC123XYZ"
                    className="h-11"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleEditInputChange("credentialUrl", e.target.value)}
                    placeholder="e.g. https://www.credential.net/..."
                    className="h-11"
                  />
                </div>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={
                !editingCertification?.name.trim() || !editingCertification?.issuer.trim()
              }
            >
              Save Changes
            </Button>
