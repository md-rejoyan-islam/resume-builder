      ...
      {educations.length === 0 && (
        <div className="text-center py-8 text-slate-500 dark:text-muted-foreground">
          ...
          <p className="text-xs mt-1">
            Add your first education above to get started.
          </p>
        </div>
      )}
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleEditInputChange("fieldOfStudy", e.target.value)
                    }
                    placeholder="e.g. Computer Science"
                    className="h-11"
                  />
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  onChange={(e) =>
                    handleEditCurrentlyStudyingChange(e.target.checked)
                  }
                  className="w-4 h-4 text-primary border-slate-300 rounded focus:ring-primary"
                />
                <label
