...
export const metadata: Metadata = {
  title: "Create New Disclosure | Professional Disclosure Builder",
  description: "Create professional disclosure documents from scratch or use templates. Build your perfect disclosure in minutes.",
};
    ...
    <div className="min-h-screen space-y-12 pb-12">
      ...
      <div className="space-y-4">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-medium">
          ...
          Create Professional Disclosures
        </div>
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground">
          Choose Your Method
        </h1>
        <p className="text-base sm:text-lg text-muted-foreground max-w-2xl">
          Select how you'd like to create your disclosure document and get started in seconds
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* From Scratch Card */}
        <Link href="/disclosures/new/from-scratch" className="group">
            ...
            <CardContent className="relative space-y-5 p-0">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                  Create a fully customized disclosure with complete control over every detail.
                </p>
              </div>
        ...
        {/* From Existing Card */}
        <Link href="/disclosures/new/from-existing" className="group">
          <Card className="relative h-full p-6 sm:p-8 bg-card/40 dark:border-accent/10 border-accent/30  hover:dark:border-accent/20 rounded-2xl hover:border-accent/50 hover:shadow-xl shadow-none  hover:shadow-accent/10 transition-all duration-300 cursor-pointer overflow-hidden">
            ...
            <CardContent className="relative space-y-5 p-0">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                  Start with one of your existing disclosures and customize for new requirements.
                </p>
              </div>
          ...
          <Card className="relative h-full p-6 sm:p-8 bg-card/40 border-2 border-dashed dark:border-accent/10 border-accent/30  hover:dark:border-accent/20 rounded-2xl shadow-none overflow-hidden">
            ...
            <CardContent className="relative space-y-5 opacity-60 p-0">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                  Generate a professional disclosure instantly using AI based on requirements.
                </p>
              </div>
...
export default NewDisclosurePage;
