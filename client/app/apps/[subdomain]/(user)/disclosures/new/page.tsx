  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        <h1 className="text-3xl font-bold">Create New Disclosure</h1>
        <p className="text-muted-foreground">
          Choose how you want to create your disclosure document
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {/* From Scratch */}
        <Link href="/disclosures/new/from-scratch">
          <div className="p-6 border border-border rounded-lg hover:border-primary hover:bg-primary/5 transition-all cursor-pointer h-full group">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Build a custom disclosure document from the ground up with full
        ...
        <div className="p-6 border border-border rounded-lg opacity-50 cursor-not-allowed h-full">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Let our AI generate a professional disclosure document based on
            requirements.
          </p>
