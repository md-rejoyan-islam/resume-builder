...
export const metadata: Metadata = {
  ...
  description: "Create professional cover letters from scratch, use existing templates, or generate with AI. Build your perfect cover letter in minutes.",
};
    ...
    <div className="min-h-screen space-y-12 pb-12">
      ...
      <div className="space-y-4">
        ...
        <p className="text-base sm:text-lg text-muted-foreground max-w-2xl">
          Select how you'd like to create your cover letter and get started in seconds
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* From Scratch Card */}
        <Link href="/cover-letters/new/from-scratch" className="group">
          <Card className="relative h-full p-6 sm:p-8 dark:bg-card/40 dark:border-accent/10 border-accent/30  border-accent/30 hover:dark:border-accent/20 rounded-2xl hover:border-accent/50 hover:shadow-xl shadow-none hover:shadow-accent/10 transition-all duration-300 cursor-pointer overflow-hidden">
            ...
            <CardContent className="relative space-y-5 p-0">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                  Create a fully customized cover letter with complete control over every detail.
                </p>
              </div>
        ...
        <Link href="/cover-letters/new/from-existing" className="group">
          <Card className="relative h-full p-6 sm:p-8 bg-card/40 dark:border-accent/10 border-accent/30  hover:dark:border-accent/20 rounded-2xl hover:border-accent/50 hover:shadow-xl shadow-none  hover:shadow-accent/10 transition-all duration-300 cursor-pointer overflow-hidden">
            ...
            <CardContent className="relative space-y-5 p-0">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                  Start with one of your existing cover letters and customize it for a new application.
                </p>
              </div>
          ...
          <Card className="relative h-full p-6 sm:p-8 bg-card/40 border-2 border-dashed dark:border-accent/10 border-accent/30  hover:dark:border-accent/20 rounded-2xl shadow-none overflow-hidden">
            ...
            <CardContent className="relative space-y-5 opacity-60 p-0">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                  Generate a professional cover letter instantly using AI based on job description.
                </p>
              </div>
